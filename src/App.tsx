...
const App: React.FC = () => {
	const palettes: { image: string; colors: string[] }[] = [
		{
			image: "/assets/images/FrenchDispatch/FrenchDispatch1.png",
			colors: ["#255059", "#86A677", "#736C48", "#BFB493", "#A65E44"],
		},
		{
			image: "/assets/images/FrenchDispatch/FrenchDispatch2.png",
			colors: ["#667F67", "#7D2828", "#8B5039", "#B69E7E", "#314F64"],
		},
		{
			image: "/assets/images/FrenchDispatch/FrenchDispatch3.png",
		...
		{
			image: "/assets/images/LifeAquatic/LifeAquatic6.png",
			colors: ["#8C0813", "#A3BAD9", "#58878C", "#736334", "#D9B8"],
		},
		{
			image: "/assets/images/LifeAquatic/LifeAquatic7.png",
			colors: ["#13421C", "#9B9295", "#A97948", "#8C1E14", "#7D4D20"],
		},
		{
			image: "/assets/images/IsleOfDogs1.png",
